...
<body data-spy="scroll" data-target=".navbar" data-offset="160">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="#skills">Competances</a></li>
	...
	<section id="about">
		<div class="col-xs-6 col-md-3 profile-picture">
			<img src="images/me.jpg" alt="Abil" class="img-circle">
		</div>
		<div class="heading">
			<h1>Hello, it's me Abil</h1>
			<h3>Developpeur Freelance | Junior</h3>
	...
	<footer class="text-center">
		...
		<h5>© 2021 APPRENDRE-A-CODER.COM</h5>
	</footer>
</body>
</html>
